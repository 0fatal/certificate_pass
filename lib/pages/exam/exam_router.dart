...
class ExamRouter implements IRouterProvider {
  ...
  void initRouter(FluroRouter router) {
    router.define(calendarPage,
        handler: Handler(handlerFunc: (_, __) => CalendarPage()));
    router.define(countdownPage,
        handler: Handler(handlerFunc: (_, __) => CountDownPage()));
    router.define(memoPage,
        handler: Handler(handlerFunc: (_, __) => MemoPage()));
    router.define(memoDetailPage,
        handler: Handler(handlerFunc: (_, __) => MemoDetailPage()));
  }
}
